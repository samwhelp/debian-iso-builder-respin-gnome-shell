...
# debian-iso-builder-respin-gnome-shell
...
| Config |
| ------ |
| [~/.config](https://github.com/samwhelp/debian-iso-builder-respin-gnome-shell/tree/main/template/asset/overlay/etc/skel/.config) |
| [/usr/share/glib-2.0/schemas](https://github.com/samwhelp/debian-iso-builder-respin-gnome-shell/tree/main/template/asset/overlay/usr/share/glib-2.0/schemas) |
| [/etc/dconf/db/distro.d](https://github.com/samwhelp/debian-iso-builder-respin-gnome-shell/tree/main/template/asset/overlay/etc/dconf/db/distro.d) |
...
> clone [debian-iso-builder-respin-gnome-shell](https://github.com/samwhelp/debian-iso-builder-respin-gnome-shell)

``` sh
git clone https://github.com/samwhelp/debian-iso-builder-respin-gnome-shell.git
```


> change dir to `debian-iso-builder-respin-gnome-shell`

``` sh
cd debian-iso-builder-respin-gnome-shell
```
...
> The resulting ISO file will be placed on `debian-iso-builder-remix-gnome-shell/dist`
